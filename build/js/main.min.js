...
window.addEventListener('DOMContentLoaded', function () {
  ...
  if (dropdown) {
    dropdown.forEach(function (dropdownInstance) {
      var dropdownWrapper = dropdownInstance.querySelector('.dropdown__wrapper');
      var dropdownList = dropdownInstance.querySelector('.dropdown__list');
      var dropdownText = dropdownInstance.querySelector('.dropdown__text');
...
},{"./modules/accordion/init-accordion":3,"./modules/form-validate/form":5,"./modules/modals/init-modals":11,"./utils/ios-vh-fix":15,"./utils/scroll-lock":16}],2:[function(require,module,exports){
"use strict";
