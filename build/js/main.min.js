...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.focusLock = new _focusLock.FocusLock();
  ...
  var heroPagination = document.querySelector('.hero__pagination-wrapper');
  var customSelectList = document.querySelectorAll('.custom-select__list');
  var feedbackFormButton = document.querySelector('.feedback__form-wrapper button[type="submit"]');
  var feedbackForm = document.querySelector('.feedback__form-wrapper form');
  var modalFormButton = document.querySelector('.modal__form-wrapper button[type="submit"]');
  var modalForm = document.querySelector('.modal__form-wrapper form');
  ...
  if (customSelectList) {
    customSelectList.forEach(function (el) {
...
},{"./modules/accordion/init-accordion":3,"./modules/form-validate/form":5,"./modules/modals/init-modals":11,"./modules/select/custom-select":14,"./utils/focus-lock":16,"./utils/ios-vh-fix":18,"./utils/scroll-lock":19}],2:[function(require,module,exports){
"use strict";
    ...
    value: function disableScrolling() {
      ...
      if (this._getScrollbarWidth()) {
        ...
        if (document.querySelector('.header') && document.querySelector('.hero .swiper-pagination') && window.matchMedia('(min-width: 1420px)').matches) {
          document.querySelector('.header').style.left = "calc(50% - ".concat(this._getScrollbarWidth(), "px)");
          document.querySelector('.header').style.translate = "calc(-50% + ".concat(Math.round(this._getScrollbarWidth() / 2), "px) 0");
          document.querySelector('.hero__pagination-wrapper').style.left = "calc(50% - ".concat(this._getScrollbarWidth(), "px)");
          document.querySelector('.hero__pagination-wrapper').style.translate = "calc(-50% + ".concat(Math.round(this._getScrollbarWidth() / 2), "px) 0");
        }
