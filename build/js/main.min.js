...
var _scrollLock = require("./modules/scroll-lock/scroll-lock");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var newsFilterList = document.querySelector('.news__filter-list');
  var newsSlidesContainer = document.querySelector('.news__slider .swiper-wrapper');
  var newsSlidesList = document.querySelectorAll('.news__slider .swiper-slide');
  var sortingNews = function sortingNews(a, b) {
  ...
  if (headerMenuWrapper && headerMenuButton && header) {
    var onClickOverlayCloseMenu = function onClickOverlayCloseMenu(evt) {
  ...
  if (newsFilterList && newsSlidesList && _vendor.newsSlider && newsSlidesContainer) {
    newsFilterList.addEventListener('click', function (evt) {
      if (evt.target.closest('.news__filter-button') && !evt.target.closest('.news__filter-button').classList.contains('is-active')) {
        ...
        var sortedDocumentFragment = new DocumentFragment();
        var pressedButton = evt.target.closest('.news__filter-button');
        var currentActiveButton = newsFilterList.querySelector('.news__filter-button.is-active');
        currentActiveButton.classList.remove('is-active');
        pressedButton.classList.add('is-active');
        var currentGroup = pressedButton.dataset.filter;
        newsSlidesContainer.replaceChildren();
        if (currentGroup === 'common') {
          newsSlidesList.forEach(function (el) {
            documentFragment.append(el);
          });
          newsSlidesContainer.append(documentFragment);
        } else {
          Array.from(newsSlidesList).forEach(function (el) {
            if (el.dataset.group === currentGroup) {
              documentFragment.append(el);
            }
          });
          Array.from(documentFragment.children).sort(sortingNews).forEach(function (el) {
            sortedDocumentFragment.appendChild(el.cloneNode(true));
          });
          newsSlidesContainer.append(sortedDocumentFragment);
        }
        _vendor.newsSlider.update();
      }
    });
  }
...
},{"./modules/accordion/init-accordion":3,"./modules/form-validate/form":5,"./modules/modals/init-modals":11,"./modules/scroll-lock/scroll-lock":14,"./utils/ios-vh-fix":17,"./vendor":19}],2:[function(require,module,exports){
"use strict";
...
},{"./ios-checker":16,"dup":14}],19:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.newsSlider = exports.heroSlider = exports.curriculumSlider = void 0;
var _swiper = _interopRequireDefault(require("./vendor/swiper"));
require("./vendor/focus-visible-polyfill");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var heroSlider = new _swiper.default('.hero', {
  slidesPerView: 'auto',
  effect: 'fade',
...
var curriculumSlider = new _swiper.default('.curriculum__slider', {
  slidesPerView: 1,
  spaceBetween: 15,
  breakpoints: {
    768: {
...
exports.curriculumSlider = curriculumSlider;
var breakpoint = window.matchMedia('(min-width:1200px)');
var newsSlider = new _swiper.default('.news__slider', {
  slidesPerView: 1,
  spaceBetween: 32,
  init: false,
  grid: {
...
breakpoint.addEventListener('change', function (evt) {
  if (!evt.matches) {
    exports.newsSlider = newsSlider = new _swiper.default('.news__slider', {
      slidesPerView: 1,
      spaceBetween: 32,
...
},{"./vendor/focus-visible-polyfill":20,"./vendor/swiper":21}],20:[function(require,module,exports){
"use strict";
