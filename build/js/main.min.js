...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var feedbackDropdown = document.querySelector('.feedback__dropdown-wrapper');
  var feedbackDropdownWrapper = document.querySelector('.feedback__form-field--dropdown');
  var feedbackList = document.querySelector('.feedback__dropdown-list');
  var dropdownText = document.querySelector('.feedback__dropdown-text');
  ...
  if (feedbackDropdown && feedbackDropdownWrapper && feedbackList && dropdownText) {
    ...
    var onClickUpdateDropdown = function onClickUpdateDropdown(evt) {
    ...
    feedbackDropdown.addEventListener('click', function () {
...
},{"./modules/accordion/init-accordion":3,"./modules/form-validate/form":5,"./modules/modals/init-modals":11,"./modules/scroll-lock/scroll-lock":14,"./utils/ios-vh-fix":17}],2:[function(require,module,exports){
"use strict";
